    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                " untuk dapat deploy perubahan terbaru dari ⚡𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​⚡.`"
            )
            repo.__del__()
            return
        ...
        if heroku_app is None:
            await event.edit(
                f"{txt}\n`Kredensial Heroku tidak valid untuk deploy 𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓 dyno.`"
            )
            return repo.__del__()
        await event.edit(
        ...
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID, "#BOT \n" "**𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​ Berhasil Di Update**"
            )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit("**𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍 𝐔𝐒𝐄𝐑𝐁𝐎𝐓​** `Berhasil Di Update!`")
    await asyncio.sleep(1)
    await event.edit("**𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍 𝐔𝐒𝐄𝐑𝐁𝐎𝐓​** `Di Restart....`")
    await asyncio.sleep(1)
    ...
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#BOT \n" "**⚡𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​⚡ Telah Di Perbarui.**"
        )
...
async def upstream(event):
    ...
    if changelog == "" and force_update is False:
        await event.edit(f"\n**⚡𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​ Sudah Versi Terbaru**\n")
        await asyncio.sleep(15)
        await event.delete()
        return repo.__del__()

    if conf is None and force_update is False:
        changelog_str = f"**Pembaruan Untuk 𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​ :\n\n⚒️ Pembaruan Data :**\n`{changelog}`"
    ...
    if force_update:
        ...
        await event.edit("` Proses Update 𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​, Loading....1%`")
        await event.edit("` Proses Update 𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​ Loading....20%`")
        await event.edit("` Proses Update 𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​, Loading....35%`")
        await event.edit("` Proses Update 𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​, Loading....77%`")
        await event.edit("` Proses Update 𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​, Updating...90%`")
        await event.edit(
            "` Proses Update 𝐒𝐔𝐏𝐄𝐑𝐌𝐀𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​, Mohon Tunggu Sebentar....100%`"
        )
